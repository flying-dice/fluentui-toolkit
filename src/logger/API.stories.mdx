...
<dl>
<dt><a href="#LoggerProvider">LoggerProvider(level, logger, namespace)</a></dt>
<dd><p>Logger provider to Wrap around an application and expose logs from flying-dice components</p>
</dd>
<dt><a href="#useLogger">useLogger(namespace)</a> ⇒ <code>ILogger</code></dt>
<dd><p>Hook to create a logger HOF which wraps a namespace</p>
</dd>
</dl>
